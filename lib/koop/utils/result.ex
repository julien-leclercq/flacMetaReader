defmodule Koop.Utils.Result do
  @moduledoc """
  Disclaimer : this module is almost entirely taken from https://github.com/fewlinesco/kaur
  only the typed_ok_tuple and typed_result_tuple are original contents
